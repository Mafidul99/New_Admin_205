    ...
    <div className="min-w-fit">
      ...
      >
        ...
        <div className="flex justify-between mb-10 w-full lg:sm:px-2">
          ...
          <button
            ref={trigger}
            className="lg:hidden text-gray-500 hover:text-gray-500 dark:text-white lg:p-0 lg:px-1 p-1 shadow rounded dark:hover:text-white border border-gray-300 hover:border-gray-400"
            onClick={() => setSidebarOpen(!sidebarOpen)}
            aria-controls="sidebar"
            aria-expanded={sidebarOpen}
          >
            <LuMenu className="w-6 h-6 text-gray-500 hover:text-gray-400 dark:text-white" />
          </button>
          {/* Logo */}
          <NavLink end to="/" className="block flex w-full items-center">
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <VscDashboard className={`w-5 h-5 shrink-0 fill-current ${pathname === "/" || pathname.includes("dashboard") ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'}`} />
