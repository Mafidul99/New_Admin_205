        ...
        <div className={`flex items-center justify-between h-16 ${variant === 'v2' || variant === 'v3' ? '' : 'lg:border-b border-gray-200  dark:border-gray-700/60'}`}>
          ...
          <div className="hidden lg:inline-flex 2xl:hidden justify-end  items-center">
            <div className="px-3 py-2">
              <button className="text-gray-500 hover:text-gray-500 dark:text-white p-1.5 cursor-pointer shadow rounded dark:hover:text-white border border-gray-300 hover:border-gray-400"
                onClick={() => setSidebarExpanded(!sidebarExpanded)}
                >
                <LuMenu className="w-6 h-6 text-gray-500 hover:text-gray-400 inline-block cursor-pointer dark:text-white" />
              </button>
            </div>
          </div>
          {/* Header: Left side */}
          <div className="flex">
            ...
            {/* Hamburger button */}
            <button
              className="lg:hidden text-gray-500 hover:text-gray-500 dark:text-white p-1 cursor-pointer shadow rounded dark:hover:text-white border border-gray-300 hover:border-gray-400"
          ...
          <div className="flex items-center space-x-3">
            <div>
              ...
              >
                ...
                <IoIosSearch className="w-5 h-5 fill-current text-gray-500/80 dark:text-gray-400/80"/>                
              </button>
